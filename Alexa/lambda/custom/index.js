...
const goodbyeText = 'Thanks for playing. It would be a tremendous help if you rated this skill in your Alexa app.';
...
const gameHandlers = Alexa.CreateStateHandler(states.gameState,  {
    ...
    'SessionEndedRequest' : function () {
        ...
        if(this.event.request.error && this.event.request.error.type && this.event.request.error.message){
            console.log('ErrorType: ' + this.event.request.error.type + '; Error Message: ' + this.event.request.error.message)
        }
