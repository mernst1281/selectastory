...
export declare class BSTVirtualAlexa {
    ...
    deleteSession(): void;
    private loadSession();
    constructor(skillURL: string, interactionModel?: string, intentSchemaFile?: string, sampleUtterancesFile?: string, applicationID?: string, locale?: string);
    context(): SkillContext;
    private validateFile(file, fileType);
    private validateJsonFiles(fileLocation, fileType);
    private validateFilesAndBuild();
    start(): void;
